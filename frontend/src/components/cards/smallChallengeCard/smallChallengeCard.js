            ...
            <CardContent>
                <div className="cover-image">
                    ...
                    <div className="text-container">
                        ...
                        <Typography variant="subtitle2" component="div" className="author">
                            by <em>{author}</em>
                        </Typography>
                    </div>
                </div>
