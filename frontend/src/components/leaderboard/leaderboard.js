    ...
    return (
        <div className="p-4">
            <div className="flex space-x-4">
                <img src={`/assets/PNG/${profileImage}.jpeg`} className="w-10 h-10 rounded-full object-cover border border-white"
                     alt="Leaderboard Profile Image"/>
                <p className="text-gray-500">{name}</p>
            </div>
            <div className="flex space-x-3 items-center">
                <div className="h-1.5 bg-blue" style={{width: `${score}%`}}/>
...
export default function Leaderboard() {
    ...
    return (
        <div className="bg-important-blue">
