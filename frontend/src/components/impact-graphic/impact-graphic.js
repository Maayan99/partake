...
const ImpactCause = ({impactCategory, setPingCategory}) => {
    ...
    return (
        <div className="flex flex-col items-center justify-between w-max relative">
            ...
            <div>
                {impactCategory.boldText && <h1 className="font-bold text-lg text-center">{impactCategory.boldText}</h1>}
...
export default function ImpactGraphic({impact, setPingCategory}) {
    ...
    return (
        <div className="flex flex-col justify-between text-sm w-max">
